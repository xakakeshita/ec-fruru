...
class OrderItem extends \Eccube\Entity\OrderItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'product_name', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'product_code', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'class_name1', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'class_name2', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'class_category_name1', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'class_category_name2', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'price', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'quantity', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'tax', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'tax_rate', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'tax_rule_id', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'currency_code', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'processor_name', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'Order', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'Product', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'ProductClass', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'Shipping', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'RoundingType', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'TaxType', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'TaxDisplayType', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'OrderItemType', '' . "\0" . 'Eccube\\Entity\\OrderItem' . "\0" . 'point_rate'];
        }
