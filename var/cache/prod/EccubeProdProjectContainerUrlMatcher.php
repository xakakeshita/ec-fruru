...
class EccubeProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/xefruru')) {
            // admin_login
            if ('/xefruru/login' === $pathinfo) {
            ...
            if (0 === strpos($pathinfo, '/xefruru/s')) {
                // admin_homepage_sale
                if ('/xefruru/sale_chart' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/xefruru/se')) {
                    // admin_homepage_nonstock
                    if ('/xefruru/search_nonstock' === $pathinfo) {
                    ...
                    if ('/xefruru/search_customer' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/xefruru/setting/shop')) {
                        // admin_setting_shop_csv
                        if (0 === strpos($pathinfo, '/xefruru/setting/shop/csv') && preg_match('#^/xefruru/setting/shop/csv(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/xefruru/setting/shop/delivery')) {
                            // admin_setting_shop_delivery
                            if ('/xefruru/setting/shop/delivery' === $pathinfo) {
                            ...
                            if ('/xefruru/setting/shop/delivery/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/xefruru/setting/shop/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/xefruru/setting/shop/delivery/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/xefruru/setting/shop/delivery/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/xefruru/setting/shop/delivery/sort_no/move' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/xefruru/setting/shop/mail')) {
                            // admin_setting_shop_mail
                            if ('/xefruru/setting/shop/mail' === $pathinfo) {
                            ...
                            if (preg_match('#^/xefruru/setting/shop/mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/xefruru/setting/shop/mail/preview' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/xefruru/setting/shop/payment')) {
                            // admin_setting_shop_payment
                            if ('/xefruru/setting/shop/payment' === $pathinfo) {
                            ...
                            if ('/xefruru/setting/shop/payment/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/xefruru/setting/shop/payment/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/xefruru/setting/shop/payment/image/add' === $pathinfo) {
                            ...
                            if (preg_match('#^/xefruru/setting/shop/payment/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/xefruru/setting/shop/payment/(?P<id>\\d+)/visible$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/xefruru/setting/shop/payment/sort_no/move' === $pathinfo) {
                        ...
                        // admin_setting_shop
                        if ('/xefruru/setting/shop' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/xefruru/setting/shop/tax')) {
                            // admin_setting_shop_tax
                            if ('/xefruru/setting/shop/tax' === $pathinfo) {
                            ...
                            if ('/xefruru/setting/shop/tax/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/xefruru/setting/shop/tax/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/xefruru/setting/system')) {
                        // admin_setting_system_authority
                        if ('/xefruru/setting/system/authority' === $pathinfo) {
                        ...
                        if ('/xefruru/setting/system/log' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/xefruru/setting/system/masterdata')) {
                            // admin_setting_system_masterdata
                            if ('/xefruru/setting/system/masterdata' === $pathinfo) {
                            ...
                            if (preg_match('#^/xefruru/setting/system/masterdata/(?P<entity>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/xefruru/setting/system/masterdata/edit' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/xefruru/setting/system/member')) {
                            // admin_setting_system_member
                            if ('/xefruru/setting/system/member' === $pathinfo) {
                            ...
                            if ('/xefruru/setting/system/member/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/xefruru/setting/system/member/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/xefruru/setting/system/member/(?P<id>\\d+)/up$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/xefruru/setting/system/member/(?P<id>\\d+)/down$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/xefruru/setting/system/member/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/xefruru/setting/system/security' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/xefruru/setting/system/system')) {
                            // admin_setting_system_system
                            if ('/xefruru/setting/system/system' === $pathinfo) {
                            ...
                            if ('/xefruru/setting/system/system/phpinfo' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/xefruru/shipping')) {
                    // admin_shipping_update_order_status
                    if (preg_match('#^/xefruru/shipping/(?P<id>\\d+)/order_status$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/shipping/(?P<id>\\d+)/tracking_number$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_shipping_edit
                    if (preg_match('#^/xefruru/shipping/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/xefruru/shipping/preview_notify_mail') && preg_match('#^/xefruru/shipping/preview_notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/xefruru/shipping/notify_mail') && preg_match('#^/xefruru/shipping/notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/xefruru/store/plugin')) {
                    if (0 === strpos($pathinfo, '/xefruru/store/plugin/api')) {
                        if (0 === strpos($pathinfo, '/xefruru/store/plugin/api/search')) {
                            // admin_store_plugin_owners_search
                            if ('/xefruru/store/plugin/api/search' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/xefruru/store/plugin/api/search/page') && preg_match('#^/xefruru/store/plugin/api/search/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/xefruru/store/plugin/api/schema_update' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/xefruru/store/plugin/api/install')) {
                            // admin_store_plugin_install_confirm
                            if (preg_match('#^/xefruru/store/plugin/api/install/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/xefruru/store/plugin/api/install' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/xefruru/store/plugin/api/delete') && preg_match('#^/xefruru/store/plugin/api/delete/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/xefruru/store/plugin/api/upgrade')) {
                            // admin_store_plugin_api_upgrade
                            if ('/xefruru/store/plugin/api/upgrade' === $pathinfo) {
                            ...
                            if (preg_match('#^/xefruru/store/plugin/api/upgrade/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/xefruru/store/plugin/api/update' === $pathinfo) {
                    ...
                    // admin_store_plugin
                    if ('/xefruru/store/plugin' === $pathinfo) {
                    ...
                    if (preg_match('#^/xefruru/store/plugin/(?P<id>\\d+)/update$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/store/plugin/(?P<id>\\d+)/enable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/store/plugin/(?P<id>\\d+)/disable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/store/plugin/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/xefruru/store/plugin/install' === $pathinfo) {
                    ...
                    if ('/xefruru/store/plugin/authentication_setting' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/xefruru/store/template')) {
                    // admin_store_template
                    if ('/xefruru/store/template' === $pathinfo) {
                    ...
                    if (preg_match('#^/xefruru/store/template/(?P<id>\\d+)/download$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/store/template/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/xefruru/store/template/install' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/xefruru/c')) {
                // admin_change_password
                if ('/xefruru/change_password' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/xefruru/content')) {
                    if (0 === strpos($pathinfo, '/xefruru/content/block')) {
                        // admin_content_block
                        if ('/xefruru/content/block' === $pathinfo) {
                        ...
                        if ('/xefruru/content/block/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/xefruru/content/block/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/xefruru/content/block/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_content_cache
                    if ('/xefruru/content/cache' === $pathinfo) {
                    ...
                    // admin_content_css
                    if ('/xefruru/content/css' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/xefruru/content/file_')) {
                        // admin_content_file
                        if ('/xefruru/content/file_manager' === $pathinfo) {
                        ...
                        if ('/xefruru/content/file_view' === $pathinfo) {
                        ...
                        if ('/xefruru/content/file_delete' === $pathinfo) {
                        ...
                        if ('/xefruru/content/file_download' === $pathinfo) {
                    ...
                    // admin_content_js
                    if ('/xefruru/content/js' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/xefruru/content/layout')) {
                        // admin_content_layout
                        if ('/xefruru/content/layout' === $pathinfo) {
                        ...
                        if (preg_match('#^/xefruru/content/layout/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/xefruru/content/layout/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/xefruru/content/layout/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/xefruru/content/layout/view_block' === $pathinfo) {
                        ...
                        if (preg_match('#^/xefruru/content/layout/(?P<id>\\d+)/preview$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/xefruru/content/maintenance' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/xefruru/content/news')) {
                        // admin_content_news
                        if ('/xefruru/content/news' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/xefruru/content/news/page') && preg_match('#^/xefruru/content/news/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/xefruru/content/news/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/xefruru/content/news/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/xefruru/content/news/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/xefruru/content/page')) {
                        // admin_content_page
                        if ('/xefruru/content/page' === $pathinfo) {
                        ...
                        if ('/xefruru/content/page/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/xefruru/content/page/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/xefruru/content/page/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/xefruru/customer')) {
                    // admin_customer
                    if ('/xefruru/customer' === $pathinfo) {
                    ...
                    // admin_customer_page
                    if (0 === strpos($pathinfo, '/xefruru/customer/page') && preg_match('#^/xefruru/customer/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/customer/(?P<id>\\d+)/resend$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/customer/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/xefruru/customer/export' === $pathinfo) {
                    ...
                    if (preg_match('#^/xefruru/customer/(?P<id>\\d+)/delivery/new$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_customer_new
                    if ('/xefruru/customer/new' === $pathinfo) {
                    ...
                    // admin_customer_edit
                    if (preg_match('#^/xefruru/customer/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
            ...
            elseif (0 === strpos($pathinfo, '/xefruru/order')) {
                // admin_shipping_csv_import
                if ('/xefruru/order/shipping_csv_upload' === $pathinfo) {
                ...
                if ('/xefruru/order/csv_template' === $pathinfo) {
                ...
                // admin_order_edit
                if (preg_match('#^/xefruru/order/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/xefruru/order/search')) {
                    if (0 === strpos($pathinfo, '/xefruru/order/search/customer/html')) {
                        // admin_order_search_customer_html
                        if ('/xefruru/order/search/customer/html' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/xefruru/order/search/customer/html/page') && preg_match('#^/xefruru/order/search/customer/html/page(?:/(?P<page_no>[^/]++))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/xefruru/order/search/customer/id' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/xefruru/order/search/product')) {
                        // admin_order_search_product
                        if ('/xefruru/order/search/product' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/xefruru/order/search/product/page') && preg_match('#^/xefruru/order/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/xefruru/order/search/order_item_type' === $pathinfo) {
                ...
                // admin_order_mail
                if (preg_match('#^/xefruru/order/(?P<id>\\d+)/mail$#sD', $pathinfo, $matches)) {
                ...
                if ('/xefruru/order/mail/view' === $pathinfo) {
                ...
                // admin_order_page
                if (0 === strpos($pathinfo, '/xefruru/order/page') && preg_match('#^/xefruru/order/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if ('/xefruru/order/bulk_delete' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/xefruru/order/export')) {
                    // admin_order_export_order
                    if ('/xefruru/order/export/order' === $pathinfo) {
                    ...
                    if ('/xefruru/order/export/shipping' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/xefruru/order/export/pdf')) {
                        // admin_order_export_pdf
                        if ('/xefruru/order/export/pdf' === $pathinfo) {
                        ...
                        if ('/xefruru/order/export/pdf/download' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/xefruru/product')) {
                if (0 === strpos($pathinfo, '/xefruru/product/c')) {
                    if (0 === strpos($pathinfo, '/xefruru/product/category')) {
                        // admin_product_category
                        if ('/xefruru/product/category' === $pathinfo) {
                        ...
                        if (preg_match('#^/xefruru/product/category(?:/(?P<parent_id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/xefruru/product/category/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/xefruru/product/category/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/xefruru/product/category/sort_no/move' === $pathinfo) {
                        ...
                        if ('/xefruru/product/category/export' === $pathinfo) {
                        ...
                        if ('/xefruru/product/category_csv_upload' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/xefruru/product/class_category')) {
                        // admin_product_class_category
                        if (preg_match('#^/xefruru/product/class_category/(?P<class_name_id>\\d+)$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/xefruru/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/xefruru/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/xefruru/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/xefruru/product/class_category/sort_no/move' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/xefruru/product/class_name')) {
                        // admin_product_class_name
                        if ('/xefruru/product/class_name' === $pathinfo) {
                        ...
                        if (preg_match('#^/xefruru/product/class_name/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/xefruru/product/class_name/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/xefruru/product/class_name/sort_no/move' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/xefruru/product/csv_template') && preg_match('#^/xefruru/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                ...
                if ('/xefruru/product/product_csv_upload' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/xefruru/product/product/class')) {
                    // admin_product_product_class
                    if (preg_match('#^/xefruru/product/product/class/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/product/product/class/(?P<id>\\d+)/clear$#sD', $pathinfo, $matches)) {
                ...
                // admin_product_page
                if (0 === strpos($pathinfo, '/xefruru/product/page') && preg_match('#^/xefruru/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/xefruru/product/product')) {
                    // admin_product_image_add
                    if ('/xefruru/product/product/image/add' === $pathinfo) {
                    ...
                    if ('/xefruru/product/product/new' === $pathinfo) {
                    ...
                    if (preg_match('#^/xefruru/product/product/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/xefruru/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/xefruru/product/classes') && preg_match('#^/xefruru/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                ...
                if ('/xefruru/product/export' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/xefruru/product/bulk/product-status') && preg_match('#^/xefruru/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/xefruru/product/tag')) {
                    // admin_product_tag
                    if ('/xefruru/product/tag' === $pathinfo) {
                    ...
                    if (preg_match('#^/xefruru/product/tag/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/xefruru/product/tag/sort_no/move' === $pathinfo) {
